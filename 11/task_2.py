...
class MainSbisRu(Region):
    tabs = CustomList(By.CSS_SELECTOR, '.controls-InputBase__nativeField_caretFilled.controls-InputBase__nativeField_caretFilled_theme_default', 'Вкладка')
...
class Test(TestCaseUI):
    def test(self):
        ...
        log('Вход в систему')
        fix_ru = MainSbisRu(self.driver)
        fix_ru.tabs.should_be(CountElements(1))
        ...
        password.send_keys('Сверк123', Keys.ENTER)
        sleep(4)
